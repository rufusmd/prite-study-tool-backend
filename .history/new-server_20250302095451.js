...
// Very simple test endpoint without auth
app.get('/api/test', (req, res) => {
    res.json({ message: 'API test endpoint is working' });
});

// Claude API endpoint - publicly accessible
...
console.log('Server initialization completed, waiting for MongoDB connection...');
...
// Update the populateQuestionsList function in app.js
function populateQuestionsList() {
    ...
    state.questions.forEach(question => {
        ...
        const hasAnswer = question.correctAnswer && question.correctAnswer.trim() !== '';
      ...
      <div class="question-item-header">
        <div class="question-item-meta">
          ...
          ${!hasAnswer ? '<span class="no-answer-badge">No Answer</span>' : ''}
        </div>
        <div class="question-item-actions">
          ${!hasAnswer ?
                '<button class="btn small success add-answer-btn" data-id="' + question._id + '">Add Answer</button>' :
                ''
            }
    ...
    `;
        ...
        questionItem.querySelector('.edit-btn').addEventListener('click', () => {
            window.editQuestion = function (id) {
                ...
                // Check if openQuestionEditor exists and is a function
                if (typeof openQuestionEditor === 'function') {
                    console.log('Opening question editor...');
                    openQuestionEditor(id);
                } else {
                    console.log('openQuestionEditor function not found. Current window functions:', Object.keys(window).filter(key => typeof window[key] === 'function'));
